...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Mrdadgoku/AnniMusicBot",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/GOKUxEDITION")
